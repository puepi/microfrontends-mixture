    ...
    return(
        <>
            ...
            </span>
            {
                showCart && (
                    <>
                        <div className="absolute p-5 border-4 border-blue-800 bg-white rounded-xl text-black"
                    ...
                    currency.format(items.reduce((a,v)=>a + v.quantity*v.price,0))
                            ...
                            <div className='flex'>
                                <div className='flex flex-grow-0'>
                                    <button id="clearcart" className='bg-white border text-green-800 py-2 px-5 rounded-md text-sm border-green-800' onClick={clearCart}>
                                        Clear cart
                                    </button>
                                </div>
